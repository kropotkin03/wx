...
class MiApp(App):
    def OnInit(self):
        ...
        self.b = b = Button(p1, -1, label="", size = (160, 210))
        b.SetBitmap(Bitmap(Image("anikka.jpg", BITMAP_TYPE_ANY).Rescale(150, 200))) # cambiar size
    ...
    def click(self, event):
        ...
        self.b.SetBitmap(Bitmap(Image("carita_feliz.jpg", BITMAP_TYPE_ANY).Rescale(150, 200)))
