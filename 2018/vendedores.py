...
class MiApp(App):
    def OnInit(self):
        ...
        for x in range(5):
            premios.append("Qué lástima, no consiguió ser TOP!")
        ...
        for linea in archivo:
            linea = linea[:-1] # le saco el barra ene, renegué, ah, y le agregué un enter al final pa no pensar
            linea = linea.split(",")
        ...
        bSorteo.Bind(EVT_BUTTON, self.tomoEmpleado) # Enlace de botón con la función de sorteo
    ...
    def tomoEmpleado(self, e):
        ...
        def salida(id, nombre, antig, premioTop, bonus1, bonus2 ):
            f2 = Frame(None, -1, "Cupón de Premios", size = (900, 400))
