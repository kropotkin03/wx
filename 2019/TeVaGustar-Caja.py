...
class MyApp(App):
    def OnInit(self):
        ...
        dvlc.AppendTextColumn('Entrega', width=100, mode=DATAVIEW_CELL_EDITABLE)
        dvlc.AppendTextColumn('Forma de pago', width=100)
        dvlc.AppendTextColumn('Retira', width=100, mode=DATAVIEW_CELL_EDITABLE)
        dvlc.AppendTextColumn('Saldo', width=100)
        dvlc.AppendTextColumn('Telefono', width=200, mode=DATAVIEW_CELL_EDITABLE)
...
#Guarda el participante
    def guardaPart(self, evt):
        ...
        self.dvlc.AppendItem([no, self.fe, en, fp, re, sa, te]) 
        print(self.fe)       
...
# End Calendario
    def grabaBD(self, pnombre, pfecha, pentrega, pformadepago, pretira, psaldo, ptelefono):
        ...
        datos = Table('datos', metadata, 
                ...
                Column('retira', String(20)),
                Column('saldo', String(20)),
