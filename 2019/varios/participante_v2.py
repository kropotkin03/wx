...
# Fecha - Caja de Texto fecha de nacimiento - Abre datepicker
        self.fe = ""
...
# Profesión - Combo
        ...
        self.pro = cb = ComboBox(p2, 500, "Especialidad", (0, 0), (160, -1), proList, CB_DROPDOWN | TE_PROCESS_ENTER )
...
# Importe - Radio Buttons
        ...
        impList = ["$80", "$150", "$200"]
        imp = self.imp = RadioBox(p2, -1, "", DefaultPosition, DefaultSize, impList, 1, NO_BORDER)
